...
?>
  ...
  <a href="logout.php"><button id="logoutButton" class="logout-button">Logout</button></a>
    ...
    <button id="addStudentBtn"><a href="addcourse.php">Add New Course</a></button>
        <div class="topTable">
        ...
        <tr>
                 <!-- <td><?php echo $row['id'] ?></td>-->
                  <td><?php echo $row['course_code'] ?></td>
                   ...
                   <td>
                  <a href="editcourse.php?id=<?php echo $row['id']?>" class="icon2"><ion-icon name="create-outline"> </ion-icon></a>
                
                   <a href="deletecourse.php?id=<?php echo $row['id']?>" class="icon2"><ion-icon name="trash-outline"></ion-icon></a>
                   </td>
